...
🧪 How It Works
The script takes a list of 3D points (atomic positions).
It defines a 3D lattice using unit cubes.
Each unit cell is checked for atom presence.
Only unit cells containing atoms are rendered.
Faces of such cells are rendered with customizable colors.
Installation
